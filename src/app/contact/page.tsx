...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#f8fafc_0%,#e0f2fe_32%,#fefce8_100%)] px-4 py-10 text-slate-950">
        ...
        <section className="overflow-hidden rounded-[32px] border border-slate-200/80 bg-[radial-gradient(circle_at_top_left,#0f172a_0%,#082f49_42%,#164e63_100%)] p-8 text-white shadow-[0_30px_100px_rgba(8,47,73,0.28)]">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-black/10 p-5 backdrop-blur">
              ...
              <p className="mt-3 text-sm leading-6 text-white/85">
                Messages are routed as email. Use a real reply address so the team can answer you directly.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <p className="text-xs leading-5 text-slate-500">
                This form uses a server-side email send. API keys stay on the server.
              </p>
            </div>
          </form>
        </section>
