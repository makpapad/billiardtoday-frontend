      ...
      >
        ...
        <div
          className={`relative flex items-center justify-between font-semibold tabular-nums ${
            compactExpandedLayout ? "gap-1.5 text-[10px] md:text-[11px]" : "gap-2 text-sm md:text-base"
          }`}
        >
          <span className={`truncate text-left flex-1 ${compactExpandedLayout ? "text-[10px] md:text-[11px]" : ""}`}>{player1Name || "Player 1"}</span>
          <span className={`flex items-center justify-center ${compactExpandedLayout ? "min-w-[34px]" : "min-w-[40px]"}`}>{p1Flag}</span>
          ...
          <span className={`flex items-center justify-center ${compactExpandedLayout ? "min-w-[34px]" : "min-w-[40px]"}`}>{p2Flag}</span>
