...
function ScoreboardMonitorCard({ entry }: { entry: PresenceEntry }) {
  ...
  return (
    <article className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">
            Screen ID
          </div>
          <div className="mt-2 truncate font-mono text-sm font-semibold text-slate-950">
            {entry.screenId}
          </div>
          {entry.venue ? (
        ...
        <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700">
          <span
            className={
              isConnected
                ? "h-2.5 w-2.5 rounded-full bg-emerald-500 shadow-[0_0_14px_rgba(34,197,94,0.5)]"
      ...
      <div className="mt-5 overflow-hidden rounded-[22px] bg-[#0f1a2d] p-1 shadow-[0_18px_36px_rgba(15,23,42,0.18)]">
        <div className="flex items-center justify-between gap-3 rounded-t-[18px] bg-[#22314b] px-4 py-2 text-white">
        ...
        <div className="space-y-1 bg-[#0f1a2d] p-1">
          ...
          {players.length === 0 ? (
            <div className="rounded-[18px] bg-[linear-gradient(90deg,#3156da_0%,#4833c7_100%)] px-4 py-5 text-sm text-white/90">
              {isConnected
