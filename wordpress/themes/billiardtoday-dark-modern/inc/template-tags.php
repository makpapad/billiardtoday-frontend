<?php
/**
 * Custom template tags for BilliardToday Dark Modern Theme
 */
 ...
 */
function billiardtoday_dark_modern_posted_on() {
 ...
 */
function billiardtoday_dark_modern_posted_by() {
    $byline = sprintf(
 ...
 */
function billiardtoday_dark_modern_entry_footer() {
 ...
 */
function billiardtoday_dark_modern_post_thumbnail() {
 ...
 */
function billiardtoday_dark_modern_get_navigation() {
 ...
 */
function billiardtoday_dark_modern_get_footer_menu() {
 ...
 */
function billiardtoday_dark_modern_custom_excerpt_length($length) {
    return 25;
}
add_filter('excerpt_length', 'billiardtoday_dark_modern_custom_excerpt_length');

/**
 * Custom excerpt more.
 */
function billiardtoday_dark_modern_custom_excerpt_more($more) {
    return '...';
}
add_filter('excerpt_more', 'billiardtoday_dark_modern_custom_excerpt_more');

/**
 * Get custom logo with fallback.
 */
function billiardtoday_dark_modern_get_logo() {
 ...
 * Get copyright text.
 */
function billiardtoday_dark_modern_get_copyright() {
    $copyright = get_theme_mod('copyright_text_modern', __('© 2024 BilliardToday. All rights reserved. Modern dark theme for champions.', 'billiardtoday'));
 ...
 * Get social links.
 */
function billiardtoday_dark_modern_get_social_links() {
    $facebook = get_theme_mod('facebook_url_modern', '');
    $twitter = get_theme_mod('twitter_url_modern', '');
    $linkedin = get_theme_mod('linkedin_url_modern', '');
...
/**
 * Get modern gradient text
 */
function billiardtoday_dark_modern_gradient_text($text, $gradient = null) {
    if (!$gradient) {
...
/**
 * Get modern card with hover effect
 */
function billiardtoday_dark_modern_card($content, $class = '') {
    return '<div class="modern-card ' . esc_attr($class) . '">' . $content . '</div>';
}

/**
 * Get modern button
 */
function billiardtoday_dark_modern_button($text, $url = '#', $type = 'primary', $icon = '') {
 ...
 * Get modern icon
 */
function billiardtoday_dark_modern_icon($name, $size = 20) {
    $icons = array(
 ...
 */
function billiardtoday_dark_modern_add_card_styles() {
    ?>
    <style>
        .modern-card {
...
add_action('wp_head', 'billiardtoday_dark_modern_add_card_styles');
?>
