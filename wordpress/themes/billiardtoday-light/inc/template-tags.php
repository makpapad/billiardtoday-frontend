<?php
/**
 * Custom template tags for BilliardToday Light Theme
 */
 ...
 */
function billiardtoday_light_posted_on() {
 ...
 */
function billiardtoday_light_posted_by() {
    $byline = sprintf(
 ...
 */
function billiardtoday_light_entry_footer() {
 ...
 */
function billiardtoday_light_post_thumbnail() {
 ...
 */
function billiardtoday_light_get_navigation() {
 ...
 */
function billiardtoday_light_get_footer_menu() {
 ...
 */
function billiardtoday_light_custom_excerpt_length($length) {
    return 25;
}
add_filter('excerpt_length', 'billiardtoday_light_custom_excerpt_length');

/**
 * Custom excerpt more.
 */
function billiardtoday_light_custom_excerpt_more($more) {
    return '...';
}
add_filter('excerpt_more', 'billiardtoday_light_custom_excerpt_more');

/**
 * Get custom logo with fallback.
 */
function billiardtoday_light_get_logo() {
 ...
 * Get copyright text.
 */
function billiardtoday_light_get_copyright() {
    $copyright = get_theme_mod('copyright_text', __('© 2024 BilliardToday. All rights reserved. Clean design for champions.', 'billiardtoday'));
 ...
 * Get social links.
 */
function billiardtoday_light_get_social_links() {
