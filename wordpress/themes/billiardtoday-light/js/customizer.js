/**
 * Customizer JavaScript for BilliardToday Light Theme
 */
...
(function($) {
    ...
    wp.customize('primary_color', function(value) {
        value.bind(function(newval) {
            ...
            $('.hero-title').css({
                'background': 'linear-gradient(135deg, #1e293b 0%, ' + newval + ' 50%, ' + wp.customize.value('secondary_color')() + ' 100%)',
    ...
    wp.customize('secondary_color', function(value) {
        value.bind(function(newval) {
            ...
            // Update hero title gradient
            $('.hero-title').css({
                'background': 'linear-gradient(135deg, #1e293b 0%, ' + wp.customize.value('primary_color')() + ' 50%, ' + newval + ' 100%)',
                '-webkit-background-clip': 'text',
                '-webkit-text-fill-color': 'transparent',
                'background-clip': 'text'
            });
    ...
    wp.customize('accent_color', function(value) {
        value.bind(function(newval) {
            ...
            $('.feature-icon:hover, .stat-icon:hover').css({
                'background': 'linear-gradient(135deg, ' + wp.customize.value('primary_color')() + ' 0%, ' + wp.customize.value('secondary_color')() + ' 100%)'
            });
        });
    });
    ...
    wp.customize('bg_secondary', function(value) {
        value.bind(function(newval) {
            ...
            $('.features, .footer').css('background', newval);
        });
    });
    ...
    var style = $('<style>')
        .prop('type', 'text/css')
        .html('body, .btn-primary, .nav-cta, .feature-icon, .stat-icon, .hero-title, .btn-secondary { transition: all 0.3s ease; }')
        .appendTo('head');
