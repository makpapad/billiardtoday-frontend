<?php
/**
 * Custom template tags for BilliardToday Minimal Theme
 */
 ...
 */
function billiardtoday_minimal_posted_on() {
 ...
 */
function billiardtoday_minimal_posted_by() {
    $byline = sprintf(
 ...
 */
function billiardtoday_minimal_entry_footer() {
 ...
 */
function billiardtoday_minimal_post_thumbnail() {
 ...
 */
function billiardtoday_minimal_get_navigation() {
 ...
 */
function billiardtoday_minimal_get_footer_menu() {
 ...
 */
function billiardtoday_minimal_custom_excerpt_length($length) {
    return 20;
}
add_filter('excerpt_length', 'billiardtoday_minimal_custom_excerpt_length');

/**
 * Custom excerpt more.
 */
function billiardtoday_minimal_custom_excerpt_more($more) {
    return '...';
}
add_filter('excerpt_more', 'billiardtoday_minimal_custom_excerpt_more');

/**
 * Get custom logo with fallback.
 */
function billiardtoday_minimal_get_logo() {
 ...
 * Get copyright text.
 */
function billiardtoday_minimal_get_copyright() {
    $copyright = get_theme_mod('copyright_text', __('© 2024 BilliardToday. All rights reserved. Minimal design for maximum focus.', 'billiardtoday'));
 ...
 * Get social links.
 */
function billiardtoday_minimal_get_social_links() {
