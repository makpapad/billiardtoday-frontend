<?php
/**
 * Custom template tags for BilliardToday New Theme
 */
 ...
 */
function billiardtoday_new_posted_on() {
 ...
 */
function billiardtoday_new_posted_by() {
    $byline = sprintf(
 ...
 */
function billiardtoday_new_entry_footer() {
 ...
 */
function billiardtoday_new_post_thumbnail() {
 ...
 */
function billiardtoday_new_get_navigation() {
 ...
 */
function billiardtoday_new_get_footer_menu() {
 ...
 */
function billiardtoday_new_custom_excerpt_length($length) {
    return 25;
}
add_filter('excerpt_length', 'billiardtoday_new_custom_excerpt_length');

/**
 * Custom excerpt more.
 */
function billiardtoday_new_custom_excerpt_more($more) {
    return '...';
}
add_filter('excerpt_more', 'billiardtoday_new_custom_excerpt_more');

/**
 * Get custom logo with fallback.
 */
function billiardtoday_new_get_logo() {
 ...
 * Get copyright text.
 */
function billiardtoday_new_get_copyright() {
    $copyright = get_theme_mod('copyright_text', __('© 2024 BilliardToday. All rights reserved. Modern design for champions.', 'billiardtoday'));
 ...
 * Get social links.
 */
function billiardtoday_new_get_social_links() {
